  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        <div class="container">
          <a class="navbar-brand" href="index.html">Hotel ABC</a>
            ...
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/presidential_rooms">Presidential Room</a>
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/luxury_rooms">Luxury Room</a>
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/deluxe_rooms">Deluxe Room</a>
                </div>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(/frontend/images/big_image_1.jpg);">
      <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-12 text-center">

            <div class="mb-5 element-animate">
              <h1>Welcome To Our Luxury and affordable Rooms</h1>
              <p>The Worlds #1 Luxury Rooms</p>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-7">
            <img src="/frontend/images/f_img_1.png" alt="Image placeholder" class="img-md-fluid">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row ">
          <div class="col-md-7">
            <div class="media d-block room mb-0">
              <figure>
                <img src="/frontend/images/img_1.jpg" alt="Generic placeholder image" class="img-fluid">
          ...
          <div class="col-md-5 room-thumbnail-absolute">
            <a href="#" class="media d-block room bg first-room" style="background-image: url(/frontend/himages/img_2.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Hotel Room 
            ...
            <a href="#" class="media d-block room bg second-room" style="background-image: url(/frontend/images/img_4.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Hotel Room 
        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              <img src="/frontend/images/img_3.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="/frontend/images/img_6.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="/frontend/images/img_5.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
